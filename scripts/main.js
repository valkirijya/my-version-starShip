...
function createStarShipDiv(name) {
  ...
  delateButton.className = "delDiv";
  delateButton.textContent = "X";
  delateButton.title = "Удалить миссию";
  starShipDiv.appendChild(delateButton);

  delateButton.onclick = function delDiv() {
    starShipDiv.remove();
    console.log("OK");
  };
  /////////////////////////////////////////////////////////////////////////////////////
...
function launch(theForm) {
  ...
  let starShipsDiv = document.getElementById("starships");
  let starShipDiv = createStarShipDiv(name);
